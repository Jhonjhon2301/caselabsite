...
export default function TopBar() {
  return (
    <div className="bg-brand-dark text-primary-foreground">
      <div className="container mx-auto flex items-center justify-between py-2 text-[11px] tracking-wide">
        ...
        <div className="flex items-center gap-5">
          <span className="hidden md:flex items-center gap-1.5 text-primary-foreground/50">
